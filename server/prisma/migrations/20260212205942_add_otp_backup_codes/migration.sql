...
-- CreateIndex
CREATE INDEX "otp_backup_codes_userId_idx" ON "otp_backup_codes"("userId");

-- AddForeignKey
ALTER TABLE "otp_backup_codes" ADD CONSTRAINT "otp_backup_codes_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
